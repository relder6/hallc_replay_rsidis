...
if __name__ == "__main__":
    runlist = read_csv("/home/cdaq/rsidis-2025/hallc_replay_rsidis/AUX_FILES/util/parse_runlist/parsed_runlist_phase2.csv")

    generate_magnet_csv(runlist, -1, "output/rsidis_phaseII_nominal_mag_currs.csv")
