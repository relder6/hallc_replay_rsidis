void replay_cosmic_shms (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* RunFileNamePattern = "shms_cosmic_%03d.dat.0";
  ...
  //  pscaler->AddEvtType(0);
  //  pscaler->AddEvtType(65360);    
  pscaler->AddEvtType(129);
  pscaler->SetDelayedType(129);
  pscaler->SetUseFirstEvent(kTRUE);
  //  pscaler->SetDebugFile("scalerDebug.txt");
